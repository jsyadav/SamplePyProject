...
class ParserTestCase(unittest.TestCase):
    ...
    def test_exact(self):
        ...
        self.assertMatch(exact, '"John said \"Hello world\""')
...
if __name__ == '__main__':
    ...
    #input = 'john "new york"'
    input = 'created_by :justin'
    #input = '"ki"'
    ret = comparison.parseString(input, parseAll=True)
    print ret
    parsed = content.parseString(input, parseAll=True)
    print parsed
    ast = parsed.asList()
    print ast